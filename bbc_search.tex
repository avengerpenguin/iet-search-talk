...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \pause \item What could a BBC-scale search application look like?
...
\begin{frame}
  ...
  \includegraphics[width=\linewidth]{scotland_topic.png}\\
\end{frame}
\note{
...
\begin{frame}
  ...
  Useful feature on BBC News Manchester website:
  \vfill
  ...
  \begin{center}
    \begin{dot2tex}[pgf,dot,scale=0.6]
      digraph G {
        ...
        iplayer_www [shape=note,label="Programmes Websites"]
        nature_www [shape=note,label="Nature Website"]

        news_db [shape=box3d,label="News Database"]
        iplayer_db [shape=box3d,label="Programmes Database"]
    ...
    \begin{dot2tex}[pgf,dot,scale=0.6]
      digraph G {
        ...
        
        {
          ...
          iplayer_service [shape=circle,label="Programmes\nService"]
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=\linewidth]{gardening.png}
\end{frame}
\note{
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=\linewidth]{search_results.png}
\end{frame}
\note{
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=2in]{results_iplayer.png}
    \quad
    \includegraphics[width=2in]{results_news.png}
  \end{center}
\end{frame}
\note{
...
\begin{frame}
  ...
  \begin{centering}
    \includegraphics[width=2in]{most_popular.png}
  \end{centering}
\end{frame}
\note{
...
\begin{frame}[fragile]
  ...
  \centering
  \includegraphics[width=4in]{tornado.jpg}
  \begin{flushright}
    \tiny
    \copyright CC-BY-SA 2013 http://en.wikipedia.org/wiki/File:May\_20,\_2013\_Moore,\_Oklahoma\_tornado.JPG
  \end{flushright}
\end{frame}
\note{
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=3in]{earth.jpg}
  \end{center}
\end{frame}
\note{
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=\linewidth]{facebook_twitter.jpg}
\end{frame}
\note{
